...
function Footer() {
  ...
  return (
    <nav
      className={`${styles.nav} ${darkThemeActive && "border-slate-800" } mt-[10em] w-full border-t-2 flex gap-5 sm:gap-20 justify-center items-center py-1 sm:py-2 text-xs font-nunito  bg-white-500 `}
    >
